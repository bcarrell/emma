...
function eq() {
  ...
  for (i = 0; i < args.length; i++) {
    result.push(this.intermediates[args[i]]);
  }
...
function takeWhile(f, more) {
  var _this = this;

  addOp(this, function() {
    var _g = _this.g,
        xs = [],
        coll = ArrProto.slice.call(_this.coll),
        len = coll.length,
        next,
        i;
    ...
    _this.intermediates.push(xs);
    _this.coll = ArrProto.slice.call(_this.coll, xs.length);
  });
